           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                            ...
                                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h3 class="align-right">{{ $data['order']['created_at'] }}
                                                        </h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            @foreach ($data['items'] as $item)
                                                                ...
                                                                <tr>
                                                                    <td width="60%" class="purchase_item">
                                                                        <span
                                                                            class="f-fallback">{{ explode('@', $item)[1] }}</span>
                                                                    </td>
                                                                    <td width="20%" class="purchase_item">
                                                                        <span
                                                                            class="f-fallback">{{ explode('@', $item)[2] }}</span>
                                                                    </td>
                            ...
                            <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell" align="center">
                                        <p class="f-fallback sub align-center">&copy; 2021 {{ env('APP_NAME') }}. All
                                            rights
                                            reserved.</p>
